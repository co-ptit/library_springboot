...
public class DateUtil {
    ...
    public static String formatDateString(Date date) {
        if (date != null) {
            SimpleDateFormat formater = new SimpleDateFormat(SHORT_DATE_PATTERN);
    ...
    public static Date setLocalTimeInDate(Date date, LocalTime localTime) {
        Calendar cal = Calendar.getInstance();
    ...
    public static LocalDateTime toLocalDateTime(Date time) {
        return LocalDateTime.ofInstant(Instant.ofEpochMilli(time.getTime()),
    ...
    public static boolean isValidLocalDate(String dateStr) {
        boolean valid = true;
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern(SHORT_DATE_PATTERN);
