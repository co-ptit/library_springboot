...
public class FastDateFormatFactoryUtil {
    ...
    private static Map<String, Format> dateFormats = new ConcurrentHashMap<>();
    private static Map<String, Format> dateTimeFormats = new ConcurrentHashMap<>();
    private static Locale locale = new Locale("vi", "VN");
    private static Map<String, Format> simpleDateFormats = new ConcurrentHashMap<>();
    private static Map<String, Format> timeFormats = new ConcurrentHashMap<>();
